...
def usage():
    ...
    print(' Query data based on date (YYYYMMDD) for all measurements (includes Nest Fan):')
    print('  python3 GetEnvData.py -n <date>\n')
    print(' Query data based on date (YYYYMMDD) and lab for all measurements (includes Nest Fan):')
    print('  python3 GetEnvData.py -n <date> <lab>\n')
